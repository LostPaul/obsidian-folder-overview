...
async function updateSettings(contentEl, yaml, plugin, defaultSettings, el, ctx, file) {
  ...
  toggleSections(contentEl, {
    ...
    "setting-file-tag": disableFileTag != null ? disableFileTag : false,
...
var FileExplorerOverview = class {
  ...
  async createFolderEL(plugin, child, folderOverview, childrenElement, sourceFolderPath) {
    ...
    if (yaml.includeTypes.includes("folder")) {
      ...
      folderTitle.addEventListener("dragover", (e) => {
        e.preventDefault();
        const { draggable } = plugin.app.dragManager;
        if (draggable && draggable.file instanceof import_obsidian42.TFolder) {
  ...
  async createFileEL(plugin, child, folderOverview, childrenElement) {
    ...
    fileTitle.addEventListener("dragover", (e) => {
      ...
      const { draggable } = plugin.app.dragManager;
      if (draggable && draggable.file instanceof import_obsidian42.TFolder) {
        plugin.app.dragManager.setAction(window.i18next.t("interface.drag-and-drop.move-into-folder", { folder: ((_a2 = child.parent) == null ? void 0 : _a2.name) || "" }));
    ...
    fileTitle.addEventListener("dragleave", (e) => {
      var _a2, _b;
      const folderEL = folderOverview.getElFromOverview(((_a2 = child.parent) == null ? void 0 : _a2.path) || "");
      if (folderEL) {
    ...
    fileTitle.addEventListener("drop", (e) => {
      ...
      const { draggable } = plugin.app.dragManager;
      if (draggable && draggable.file instanceof import_obsidian42.TFolder) {
        plugin.app.fileManager.renameFile(draggable.file, ((_a2 = child.parent) == null ? void 0 : _a2.path) + "/" + draggable.file.name);
      }
    });
    fileTitle.onclick = () => {
